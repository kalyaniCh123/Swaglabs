...
public class SaucelabsTestPage {
	...
	*/
	...
	public void enters_the_personal_details() throws Throwable {
		driver.findElement(By.id("first-name")).sendKeys("Kalyani");
		driver.findElement(By.id("last-name")).sendKeys("Kallu");
		driver.findElement(By.xpath("//input[@id='postal-code']")).sendKeys("@#23");
		checkout.clickOnContinueButton();
